...
const UserProfileImage = () => {
  const avatarUrl = 'https://res.cloudinary.com/ddga6y6tm/image/upload/v1741178088/avatar_rlr5jl.png';

  return <Image source={{ uri: avatarUrl }} style={styles.profileImage} />;
};

// TaskItem component for each row in the FlatList
...
export default function HomeScreen() {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      try {
        const response = await fetch('https://68f0d65e0b966ad5003461f8.mockapi.io/api/data');
